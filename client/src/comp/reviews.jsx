...
const Reviews = () => {
    ...
    useEffect(() => {
        const fetchReviews = async () => {
            try {
                ...
                const approvedReviews = data.filter(review => review.approved === true);
    ...
    if (loading) return <p style={{textAlign:"center", marginTop:"250px"}}>Loading reviews...</p>;
    ...
    return (
        <section className="reviews-section">
            ...
            <div className="slider-container">
                <button className="slider-arrow left" onClick={() => slide('left')} aria-label="Previous review">
                    <FiChevronLeft />
                </button>
                ...
                <button className="slider-arrow right" onClick={() => slide('right')} aria-label="Next review">
                    <FiChevronRight />
                </button>
            </div>
        </section>
